...
"<h4>STRATEGY</h4>We identified the most relevant social networks in our publisher portfolio and distributed the 3-video series via our full-screen branded player.",
"<h4>RESULTS</h4>The campaign achieved <B>1,089,898</B> total views, with <B>38,766</B> post-view interactions (including <B>18,919</B> clicks to &#8220;See More&#8221;).","fiat.mp4"];
...
"<h4>RESULTS</h4>The campaign delivered over <B>530,000</B> views, with over <B>8,700</B> post-view interactions, including <B>3,369</B> clicks to the Beneful Facebook page and <B>3,089</B> replays.","mcdonalds.mp4"];
...
"<h4>RESULTS</h4>The program delivered <B>961,712</B> views, with <B>8,413</B> clicks Dove&#8217;s self-esteem site and over <B>103MM</B> mobile impressions included as added value.","dove.mp4"];

csInfo[4] = [
"PURINA","<h4>SITUATION</h4>The Friskies brand needed a way to build awareness around their humorous video, featuring comedian Chris Parnell.",
...
"<h4>RESULTS</h4><B>745,702</B> total views, with <B>26,348</B> post-view interactions, translating to a <B>4.2%</B> engagement rate.","purina.mp4"];
...
"<h4>STRATEGY</h4>We used our proprietary pre-qualification tools to deliver the video to an audience that was 100 percent 21+.",
"<h4>RESULTS</h4>The campaign garnered <B>1,049,716</B> total views &#8211; <B>150,875</B> views over the initially promised amount. The campaign generated <B>29,601</B> post-view interactions, including <B>13,541</B> Facebook visits to &#8220;Win Your Beach.&#8221;.","corona.mp4"];
...
"<h4>RESULTS</h4>Over <B>1MM</B> video views and a <B>44%</B> engagement rate, resulting in <B>444,063</B> clicks to Samsung&#8217;s Facebook page.","samsung.mp4"];
...
//alert(csInfo[0][1]);
	...
	function csClick()	{
			...
			setTimeout(function(){
				vidInit(csNumber,665,374);
			},1)
	}
	
	
	function vidInit(whichVid,width,height)	{
		if (whichVid)	{
